...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { etiquetas: @tarefa.etiquetas, lista_tarefa_id: @tarefa.lista_tarefa_id, nome_tarefa: @tarefa.nome_tarefa, prazo: @tarefa.prazo, status: @tarefa.status } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { etiquetas: @tarefa.etiquetas, lista_tarefa_id: @tarefa.lista_tarefa_id, nome_tarefa: @tarefa.nome_tarefa, prazo: @tarefa.prazo, status: @tarefa.status } }
